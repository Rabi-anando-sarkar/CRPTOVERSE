...
const CryptoDetails = () => {
  ...
  const stats = [
    ...
    { title: '24h Volume', value: `$ ${cryptoDetails?.sparkline && millify(cryptoDetails?.sparkline)}`, icon: <ThunderboltOutlined /> },
    ...
    <Col className='coin-detail-container'>
      ...
      <Col className='stats-container'>
        <Col className='coin-value-statistics'>
          <Col className='coin-value-statstics-heading'>
            ...
            <p>
              An overview showing statistics of {data?.data?.coin.name}
            </p>
          </Col>
        ...
        <Col className='other-stats-info'>
          <Col className='coin-value-statstics-heading'>
            ...
            <p>
              An overview showing statistics of all Crypto Currencies.
            </p>
          </Col>
      ...
      <Col className='coin-desc-link'>
         <Row className='coin-desc'>
          ...
          <a href={data?.data?.coin.coinrankingUrl} target="_blank" rel="noopener noreferrer">
            Learn more on CoinRanking
          </a>
          </Title>
        </Row> 
